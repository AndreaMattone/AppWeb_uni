...
public class MiePrenotazioniEffettuateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mie_prenotazioni_effettuate, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        params.put("action", "android_getPrenotazioniEffettuate");
        ...
        client.post(GlobalVariables.getLink() + "Servlet", params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ...
                try {
                    ...
                    /*Recupero gli oggetti JSON relativi alla risposta con l'elenco delle prenotazioni effettuate
                     * */
                    int responseLength = response.length();
                    ArrayList<JSONObject> myEffettuate = new ArrayList<>();
                    for(int c=0;c<responseLength;c++){
                        myEffettuate.add(response.getJSONObject(c));
                    }
                    //System.out.println(myEffettuate.toString());

                    /*Valorizzo la listView
                     * */
                    ArrayList<String> prenEff = new ArrayList<>();
                    for(int c=0;c<responseLength;c++){
                        JSONObject tmpObj = myEffettuate.get(c);
                        ...
                        prenEff.add("Docente:"+docenteP+" corso: "+corsoP+" del giorno: "+giornoRipetizione+" nel seguente slot: "+slotRipetizione);
                    }
                    ListView activeListViewEff =  (ListView) getView().findViewById(R.id.activeListViewEff);
                    ArrayAdapter<String> adapter  = new ArrayAdapter<String> (getContext().getApplicationContext(),
                            android.R.layout.simple_list_item_1, prenEff);
